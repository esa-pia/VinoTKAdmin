...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { date_debut: @newsletter.date_debut, date_fin: @newsletter.date_fin, info: @newsletter.info, titre: @newsletter.titre }
    end
  ...
  test "should update newsletter" do
    put :update, id: @newsletter, newsletter: { date_debut: @newsletter.date_debut, date_fin: @newsletter.date_fin, info: @newsletter.info, titre: @newsletter.titre }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
